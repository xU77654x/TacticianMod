...
@AutoAdd.Ignore
public class ExpInjury extends BaseCard {
    public static final String ID = makeID(ExpInjury.class.getSimpleName());
    ...
    public ExpInjury(Runnable onUseOrChosen) {
        super(ID, info);
    ...
    @Override
    public AbstractCard makeCopy() { return new ExpInjury(onUseOrChosen); }
}