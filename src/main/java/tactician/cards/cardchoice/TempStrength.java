...
@AutoAdd.Ignore
public class TempStrength extends TacticianCard {
	public static final String ID = makeID(TempStrength.class.getSimpleName());
	...
	@Override
	public AbstractCard makeCopy() { return new TempStrength(onUseOrChosen); }
}