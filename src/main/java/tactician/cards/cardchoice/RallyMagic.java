...
@AutoAdd.Ignore
public class RallyMagic extends TacticianCard {
    public static final String ID = makeID(RallyMagic.class.getSimpleName());
    ...
    @Override
    public AbstractCard makeCopy() { return new RallyMagic(onUseOrChosen); }
}