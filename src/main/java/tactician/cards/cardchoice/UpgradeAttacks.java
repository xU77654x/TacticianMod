...
@AutoAdd.Ignore
public class UpgradeAttacks extends TacticianCard {
    public static final String ID = makeID(UpgradeAttacks.class.getSimpleName());
    ...
    @Override
    public AbstractCard makeCopy() { return new UpgradeAttacks(onUseOrChosen); }
}