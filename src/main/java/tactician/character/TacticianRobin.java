...
public class TacticianRobin extends CustomPlayer {
    ...
    public static class Meta {
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new TacticianRobin(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public AbstractCard getStartCardForEvent() {
        // This card is used for the Gremlin card matching game. It should ideally be a non-Strike/Defend Basic card.
