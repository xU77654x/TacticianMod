...
public class MastersTacticsPower extends AbstractPower {
	public static final String POWER_ID = TacticianMod.makeID("MastersTacticsPower");
	...
	public MastersTacticsPower(int amount) {
		this.name = NAME;
		this.ID = POWER_ID;
	...
	public AbstractPower makeCopy() { return new MastersTacticsPower(this.amount); }
}