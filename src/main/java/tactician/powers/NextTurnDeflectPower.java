...
public class NextTurnDeflectPower extends AbstractPower {
	public static final String POWER_ID = TacticianMod.makeID("NextTurnDeflectPower");
	...
	public NextTurnDeflectPower(int amount) {
		this.name = NAME;
		this.ID = POWER_ID;
