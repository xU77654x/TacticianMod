...
public class Speedwing extends BaseRelic {
    ...
    private static final int VIGOR = 3; // This is used rather than a hard-coded value due to the description.
    ...
    public String getUpdatedDescription() {
        return this.DESCRIPTIONS[0] + VIGOR + this.DESCRIPTIONS[1];
    }
    ...
    public void atTurnStart() {
        ...
        if (this.counter == TURN) {
            ...
            addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new VigorPower(AbstractDungeon.player, VIGOR), VIGOR));
            this.counter = -1;
            this.grayscale = true;
        }
    }
